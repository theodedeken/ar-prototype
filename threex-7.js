...
TextWrapper.prototype.Wrap = function (options) {
    ...
    while (cutText.length > options.lineLength) {
        ...
        var textGeometry = new THREE.TextGeometry(line, { size: options.size, height: options.height, font: options.font }),
    ...
    var textGeometry = new THREE.TextGeometry(cutText, { size: options.size, height: options.height, font: options.font }),
        textMaterial = new THREE.MeshLambertMaterial({ color: options.color }),
